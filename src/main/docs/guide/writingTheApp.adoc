...
http://guides.micronaut.io/micronaut-microservices-services-discover-consul-kotlin/guide/index.html[Consul and Micronaut - Microservices service discovery
